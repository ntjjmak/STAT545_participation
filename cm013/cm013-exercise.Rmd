...
This is done using the `breaks` argument.
...
p_scales +
    ...
    scale_y_continuous(breaks=1:10 *10) #take the vector 1-10 and multiply by 10
```
...
#The top rows are the sequential color schemes. The bottom ones are the diverging patterns. Diverging are used for data that are neutral in the middle and increasingly "hot or cold" on either side.
