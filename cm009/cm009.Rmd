...
Read the dollar-delimited `iris` data to a tibble. Note: Delim = how the columns are delimited. 
...
`uncount` (as the opposite of `dplyr::count()`) Can make an additional row for the data you are missing.
```{r}
